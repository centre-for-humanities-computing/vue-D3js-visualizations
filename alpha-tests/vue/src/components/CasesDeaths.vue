...
<script>
Vue.LoadScript("https://cdnjs.cloudflare.com/ajax/libs/d3/3.5.6/d3.min.js");
Vue.LoadScript("https://cdn.plot.ly/plotly-latest.min.js");
Vue.LoadScript(
  "https://cdnjs.cloudflare.com/ajax/libs/regression/1.4.0/regression.min.js"
);
Vue.LoadScript(
